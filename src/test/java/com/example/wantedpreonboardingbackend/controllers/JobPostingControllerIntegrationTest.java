...
import com.example.wantedpreonboardingbackend.utilities.TestUtils;
...
class JobPostingControllerIntegrationTest {
    ...
    void patchJobPostingSuccess(TestArg originalPost, TestArg patchPost, TestArg expectedPost) throws Exception {
        Company company = createCompany(companyRepository, "원티드랩", "한국", "서울");
        JobPosting jobPosting = createJobPosting(jobPostingRepository, company, originalPost.position, originalPost.reward, originalPost.detail, originalPost.skill);
    ...
    void getJobPostings() throws Exception {
        Company company1 = createCompany(companyRepository, "원티드랩", "한국", "서울");
        JobPosting jobPosting1 = createJobPosting(jobPostingRepository, company1, "포지션1", 10000, "설명1", "기술1");
        JobPosting jobPosting2 = createJobPosting(jobPostingRepository, company1, "포지션2", 20000, "설명2", "기술2");
        JobPosting jobPosting3 = createJobPosting(jobPostingRepository, company1, "포지션3", 30000, "설명3", "기술3");

        Company company2 = createCompany(companyRepository, "원티드코리아", "한국", "부산");
        JobPosting jobPosting4 = createJobPosting(jobPostingRepository, company2, "포지션4", 40000, "설명4", "기술4");
        JobPosting jobPosting5 = createJobPosting(jobPostingRepository, company2, "포지션5", 50000, "설명5", "기술5");
        JobPosting jobPosting6 = createJobPosting(jobPostingRepository, company2, "포지션6", 60000, "설명6", "기술6");
    ...
    void getJobPostingsWithQuery(String query, List<Integer> expectedIndex) throws Exception {
        Company company1 = createCompany(companyRepository, "원티드랩", "한국", "서울");
        JobPosting jobPosting1 = createJobPosting(jobPostingRepository, company1, "포지션1", 10000, "설명1", "Java");
        JobPosting jobPosting2 = createJobPosting(jobPostingRepository, company1, "포지션2", 20000, "설명2", "Python");
        JobPosting jobPosting3 = createJobPosting(jobPostingRepository, company1, "포지션3", 30000, "설명3", "Java");

        Company company2 = createCompany(companyRepository, "원티드코리아", "한국", "부산");
        JobPosting jobPosting4 = createJobPosting(jobPostingRepository, company2, "포지션4", 40000, "설명4", "Python");
        JobPosting jobPosting5 = createJobPosting(jobPostingRepository, company2, "포지션5", 50000, "설명5", "Java");
        JobPosting jobPosting6 = createJobPosting(jobPostingRepository, company2, "포지션6", 60000, "설명6", "Python");
